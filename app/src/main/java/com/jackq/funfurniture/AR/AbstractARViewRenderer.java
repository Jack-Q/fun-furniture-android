...
public abstract class AbstractARViewRenderer extends Renderer {
    ...
    private static final String TAG = "AbstractARViewRenderer";
    ...
    public AbstractARViewRenderer(Activity activity, ARApplicationSession session) {
        ...
        vuforiaDevice.setMode(Device.MODE.MODE_AR); // Working in VR or AR mode
    ...
    protected abstract void onUpdateARViewScene(State state, float[] projectionMatrix);
