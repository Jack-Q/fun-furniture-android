...
abstract class AbstractARViewRenderer extends Renderer {
    ...
    public AbstractARViewRenderer(Activity activity, VuforiaApplicationSession session) {
    ...
    abstract void onUpdateARViewScene(State state, float[] projectionMatrix);
